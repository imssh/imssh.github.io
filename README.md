自动点击器高级版应用（原名图灵自动点击器，以下简称“本应用”）是北京寻到科技工作室（以下简称“寻到科技”或“我们”）为您提供的手机辅助服务产品。
...
收集数据类型：
【必要信息】
设备信息：【Android】设备品牌、型号、软件系统版本、分辨率、网络信号强度、IP地址、设备语言、加速度传感器信息等基础信息、AndroidID
应用信息：开发者应用名、应用包名、版本号、应用安装列表等信息(软件安装列表/软件列表）、运行中进程信息、剪贴板
其他信息：运营商信息、设备时区、设备语言
【可选信息】
无线网SSID名称、WiFi路由器MAC地址、设备MAC地址、IP地址、设备唯一标识符（设备硬件序列号，如IMEI、AndroidID、OAID、IMSI、ICCID、GAID、MEID，具体字段因软硬件版本不同而存在差异）、手机号码、设备地理位置、手机重启时间、磁盘总空间、系统总内存空间、CPU数目、开发者应用名、应用包名、版本号、运营商信息、设备时区、获取和监听设备传感器
公司名称：北京巨量引擎网络技术有限公司
